# Project Inspection — Superpowers

This folder contains a structured inspection of the Superpowers project to help you decide whether to install it as a Claude Code plugin.

## Contents

| File | Contents |
|------|----------|
| [overview.md](overview.md) | What the project is, who it's for, and what it covers |
| [prerequisites.md](prerequisites.md) | What to install before installing Superpowers (Tier 1/2/3 tools) |
...
**Install if:**
- You use Claude Code regularly for software development
- You want consistent, structured workflows (TDD, systematic debugging, design-first)
- You work with GitHub and need `gh` CLI integration
